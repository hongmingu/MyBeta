...
package com.doitandroid.mybeta.Cropper;
...
public class CropImageActivity extends AppCompatActivity
  ...
  Toolbar toolbar;
  CoordinatorLayout tb_crop_enter_cl, tb_crop_back_cl;
  ...
  public void onCreate(Bundle savedInstanceState) {
    ...
    toolbar = findViewById(R.id.tb_tb_crop);
    setSupportActionBar(toolbar);
    getSupportActionBar().setDisplayShowTitleEnabled(false);

    tb_crop_back_cl = findViewById(R.id.tb_crop_back_cl);
    tb_crop_back_cl.setOnClickListener(this);
    tb_crop_enter_cl = findViewById(R.id.tb_crop_enter_cl);
    tb_crop_enter_cl.setOnClickListener(this);
...
/*    ActionBar actionBar = getSupportActionBar();
    if (actionBar != null) {
      ...
      actionBar.setBackgroundDrawable(getResources().getDrawable(R.drawable.bg_green_radius4dp));
...
*/
  ...
  private void updateMenuItemIconColor(Menu menu, int itemId, int color) {
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.tb_crop_back_cl:
                setResultCancel();
                break;
            case R.id.tb_crop_enter_cl:
